...
vim.keymap.set('n', '<leader>vs', ":vsplit<cr>", { desc = "VSplit" })
...
vim.keymap.set('n', '<leader>gf', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' })
...
vim.keymap.set('n', '<leader>nf', ':Telescope file_browser path=%:p:h<cr>', { desc = 'telescope file_browser' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>am', vim.lsp.buf.code_action, 'Code Action')
  nmap('<leader>rf', vim.lsp.buf.format, 'Code Action')
